...
<body>
	<div class="banner">
	  ...
	  <div class="header_bottom">
	   <div class="logo">
		  <h1><a href="{{ url("/home") }}"><span class="m_1">W</span>atches</a></h1>
	   </div>
   	   <div class="menu">
	     <ul class="megamenu skyblue">
					...
					<div class="row">
						<div class="col1">
							<div class="h_nav">
								...
								<ul>
									...
									<li><a href="{{ url("/men") }}">watches</a></li>
									<li><a href="{{ url("/men") }}">Blazers</a></li>
									<li><a href="{{ url("/men") }}">Suits</a></li>
									<li><a href="{{ url("/men") }}">Trousers</a></li>
									<li><a href="{{ url("/men") }}">Jeans</a></li>
									<li><a href="{{ url("/men") }}">Shirts</a></li>
									<li><a href="{{ url("/men") }}">Sweatshirts & Hoodies</a></li>
									<li><a href="{{ url("/men") }}">Swim Wear</a></li>
						...
						<div class="col1">
							<div class="h_nav">
								...
								<ul>
									<li><a href="{{ url("/men") }}">Watches</a></li>
									<li><a href="{{ url("/men") }}">Outerwear</a></li>
									<li><a href="{{ url("/men") }}">Dresses</a></li>
									<li><a href="{{ url("/men") }}">Handbags</a></li>
									<li><a href="{{ url("/men") }}">Trousers</a></li>
									<li><a href="{{ url("/men") }}">Jeans</a></li>
									<li><a href="{{ url("/men") }}">T-Shirts</a></li>
									<li><a href="{{ url("/men") }}">Shoes</a></li>
									<li><a href="{{ url("/men") }}">Coats</a></li>
									<li><a href="{{ url("/men") }}">Accessories</a></li>
								</ul>	
							</div>							
						</div>
			...
			<li><a class="color4" href="#">womens</a>
				...
				<li><a class="color10" href="{{ url("/brands") }}">Brands</a></li>
